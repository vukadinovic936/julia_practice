...
messy_sentence_1 = filter(isinalphabet, "#wow 2020 ¥500 (blingbling!)")
...
unused_letters = alphabet[findall(iszero,sample_freqs)]
...
function completions_cache(grams)
	...
	for i in 1:length(grams)
		if haskey(cache, grams[i][1:n-1])
			append!(cache[grams[i][1:n-1]],[grams[i][n]])
		else
...
# ╔═╡ 9e474334-43b3-11eb-17a5-fbce77c027bb
...
# ╔═╡ 0cb1d8f6-43b5-11eb-1c2b-8da68b91d313
rand(2)
